...
export default function WeatherWidget() {
  ...
  return (
    ...
    <div className="flex justify-center items-center h-screen">
      ...
      <Card className="w-full max-w-md mx-auto text-center bg-slate-400">
        {/* Card header with title and description */}
        <CardHeader className="bg-slate-500 text-white text-2xl border-4 border-orange-500 rounded-md">
          <CardTitle>Weather Widget</CardTitle>
          <CardDescription className="text-white font-serif text-xl">
            Search for the current weather conditions in your city.
          </CardDescription>
        </CardHeader>
        {/* Card content including the search form and weather display */}
        <CardContent className="bg-slate-400 font-serif text-white text-4xl border-4 border-orange-500 rounded">
          {/* Form to input and submit the location */}
          <form onSubmit={handleSearch} className="flex items-center gap-2 bg-pink-500 rounded">
            <Input
              type="text"
